...
insert into users(username,password,first_name,last_name,email) values ('Chris','Chris','Chris','Tonka','Chris@Chris.com');
insert into users(username,password,first_name,last_name,email) values ('Carol','Carol','Carol','Tonka','Carol@Carol.com');
insert into users(username,password,first_name,last_name,email) values ('Derek','Derek','Derek','Tonka','Derek@Derek.com');
insert into users(username,password,first_name,last_name,email) values ('Admin','Admin','Admin','Admin','admin@Admin.com');
